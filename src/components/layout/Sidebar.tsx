...
export const Sidebar = () => {
    ...
    return (
        <div id="sidebar" className={isCollapsed ? 'collapsed' : ''} style={{
            ...
            {/* Profile Section */}
            <div style={{ padding: isCollapsed ? '16px 8px' : '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {user ? (
                    <>
                        <div
                            style={{
                        ...
                        {!isCollapsed && milestoneStats && (
                            <NavLink to="/exam" style={{ textDecoration: 'none', color: 'inherit' }}>
                                <div style={{
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.8rem', fontWeight: 700, opacity: 0.9 }}>
                                        <span>Current Focus</span>
                                        <span>{Math.round(milestoneStats.pct)}%</span>
                                    </div>
                                    <div style={{ fontSize: '0.95rem', fontWeight: 800 }}>{milestoneStats.title}</div>
                                    <div style={{ height: '8px', background: 'rgba(255,255,255,0.2)', borderRadius: '4px', overflow: 'hidden' }}>
                                        <div style={{ width: `${milestoneStats.pct}%`, background: 'var(--md-sys-color-primary)', height: '100%' }} />
                                    </div>
                        ...
                        {!isCollapsed && (
                            <NavLink to="/" style={{ textDecoration: 'none', color: 'inherit' }}>
                                <div style={{
                                    ...
                                    <div>
                                        <div style={{ fontSize: '0.8rem', fontWeight: 700, opacity: 0.9 }}>Total Papers Done</div>
                                        <div style={{ fontSize: '1.5rem', fontWeight: 800 }}>{totalCompleted}</div>
                                    </div>
                                    <div style={{
